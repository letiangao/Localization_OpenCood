...
from opencood.data_utils.datasets.localization_early_fusion_vis_dataset import  \
    LocalizationEarlyFusionVisDataset
...
if __name__ == '__main__':
    ...
    params = load_yaml(os.path.join(current_path,
                                    '../hypes_yaml/visualization_localization.yaml'))

    opencda_dataset = LocalizationEarlyFusionVisDataset(params, visualize=True,
                                            train=False)
